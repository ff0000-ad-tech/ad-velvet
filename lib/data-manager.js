 ...
 * }
 */
export const init = async (slugs, dateSettings, adDimensions, adElement) => {
...
const handleAdDataLoadComplete = async (adDataRaw) => {
	console.log('Velvet addata:')
